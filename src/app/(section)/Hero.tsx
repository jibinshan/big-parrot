      ...
      <div className="relative flex w-full items-center justify-center px-4 py-12 h-[100vh] md:py-24">
        ...
        <div className="z-10 flex w-full md:px-[120px] flex-col items-center md:items-start justify-center gap-10">
          <p className="w-full text-center md:text-start font-cormorant text-4xl font-[400] text-white md:text-8xl uppercase lg:leading-[94px]">
            GREAT TAPAS IN<br /> MANCHESTER
          </p>
          <p className="w-full text-center md:text-start font-cormorant text-2xl font-[400] text-white uppercase">WELCOME TO CHORLTON TAPAS RESTURANT</p>
