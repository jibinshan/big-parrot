        ...
        <section className="relative flex h-full w-full justify-center items-center bg-background py-12 pb-32 md:py-34 overflow-hidden">
            <div className="flex h-full w-full flex-col items-start justify-center gap-4 md:gap-14 z-20">
                <div className="flex h-full w-full flex-col items-center justify-center gap-4 lg:gap-8">
                    <p className="font-playfair font-[500] capitalize text-primary text-2xl text-center py-3 px-7 rounded-full border-[1px] border-[#e32352]">
                        Reviews
                    </p>
                    <p className="font-cormorant non-italic uppercase text-primary font-[600] text-2xl md:text-5xl text-center flex gap-3 justify-center items-center">
                        WHY PEOPLE<br />BELIEVE IN US!
                    </p>
                </div>
                        ...
                        <Carousel className="w-full px-4 md:px-0">
                            <CarouselContent className="ml-4 flex h-fit w-full justify-center gap-4">
                                {reviews.map((review, index) => (
                                    <CarouselItem key={index} className="md:basis-1/2 flex justify-center border-[1px] border-[#dcb355] py-7 md:py-12">
                                        <div className="w-full flex flex-col px-3  gap-7">
                                            <div className="relative w-full px-4 md:h-fit flex flex-col gap-3 justify-center items-center">
                                                ...
                                                <div className="z-20">
                                                    <p className="text-primary font-[400] font-cormorant text-lg line-clamp-5 text-center">{review.text}</p>
                                                </div>
                                            </div>
                                            <div className="w-full flex flex-col items-center justify-center">
                                                ...
                                                <div className="flex flex-col justify-center items-center">
                                                    <p className="text-primary font-[500] font-playfair text-xl">-{review.author_name}-</p>
