...
const Special = ({ }) => {
  ...
  return (
    <section className="relative flex h-full w-full justify-center items-center bg-background py-12 md:py-24 overflow-hidden">
      <div className="flex h-full w-full max-w-[1300px] flex-col items-center justify-center gap-4 z-40">
        ...
        <div className="w-full flex justify-start items-center">
          <p className="font-cormorant font-[300] capitalize text-[#3A000F] text-3xl text-center py-3 px-5 rounded-full border-[1px] border-[#f095ac]">
            Our Menu
          </p>
        </div>
